...
function! fn#floatwin#open(bufnr, width, height, pos, title) abort
  ...
  " let border_options.focusable = v:false
  let g:glance_borderchars = ['─', '│', '─', '│', '╭', '╮', '╯', '╰']
  let [c_top, c_right, c_bottom, c_left, c_topleft, c_topright, c_botright, c_botleft] = g:glance_borderchars
